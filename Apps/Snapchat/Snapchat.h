...
// Upload Media 
@interface SCSwipeViewContainerViewController : UIViewController <UIImagePickerControllerDelegate,
...
// Save Chat 
@interface SCArroyoMessageActionHandler : NSObject
-(void)saveMessageInConversationId:(id)arg1 messageId:(id)arg2 source:(NSInteger)arg3;
@end

@interface SCChatMessageCellViewModel : NSObject
